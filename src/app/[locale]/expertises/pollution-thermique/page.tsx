...
export default function PollutionThermalPage() {
  const t = useTranslations('pollutionThermalPage');
              ...
              <ul className="space-y-3">
                {services.map((service, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <span className="mt-1.5 h-2 w-2 rounded-full bg-teal-dark flex-shrink-0" />
